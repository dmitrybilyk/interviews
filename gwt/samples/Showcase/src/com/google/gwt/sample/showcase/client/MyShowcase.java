 ...
 */
public class MyShowcase implements EntryPoint {
  /**
...
//    images.css().ensureInjected();
    ...
    ShowcaseConstants constants = GWT.create(ShowcaseConstants.class);
      ...
      CwCheckBox cwCheckBox = new CwCheckBox(constants);
      RootPanel.get().add(cwCheckBox);
...
//    createSiteMap(contentWidgets);
   ...
   *
   * @param contentWidgets the {@link com.google.gwt.sample.showcase.client.ContentWidget}s used in Showcase
   */
  ...
  /**
   * Set the content to the {@link com.google.gwt.sample.showcase.client.ContentWidget}.
   *
   * @param content the {@link com.google.gwt.sample.showcase.client.ContentWidget} to display
   */
