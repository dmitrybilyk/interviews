  ...
  public Widget asWidget() {
    if (panel == null) {
      ...
      SummaryColumnConfig<Task, Task> cost = new SummaryColumnConfig<Task, Task>(new IdentityValueProvider<Task>(), 20,
          "Cost");
      cost.setCellClassName("cost-column");
      cost.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_RIGHT);
      ...
      editing.addEditor(estimate, new DoubleField());
      editing.addEditor(rate, new DoubleField());
