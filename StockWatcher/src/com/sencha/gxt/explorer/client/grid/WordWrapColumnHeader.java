...
/**
 * A {@link com.sencha.gxt.widget.core.client.grid.Grid} {@link com.sencha.gxt.widget.core.client.grid.ColumnHeader} that supports word wrap, enabling long column headings to be displayed in
...
public class WordWrapColumnHeader<M> extends ColumnHeader<M> {
  ...
  protected class WordWrapHead extends Head {
   ...
   * new word wrap column header, invoke {@link com.sencha.gxt.widget.core.client.grid.GridView#setColumnHeader(com.sencha.gxt.widget.core.client.grid.ColumnHeader)}, e.g.
