...
@Detail(name = "Logos", icon = "sencha", category = "Draw")
public class LogoExample implements IsWidget, EntryPoint {
  ...
  public Widget asWidget() {
    if (panel == null) {
      ...
      senchaComponent = new DrawComponent();
      ...
      component.addSprite(logo);
      component.addGradient(blackBlue);
      component.setViewBox(true);
      tabPanel.add(component, "Firefox");
      ...
      component.addGradient(blackBlue);
      component.setViewBox(true);
      tabPanel.add(component, "Safari");

      panel = new FramedPanel();
      panel.setLayoutData(new MarginData(10));
      panel.setCollapsible(true);
      panel.setHeadingText("Logo Example");
      panel.setPixelSize(320, 300);
      panel.add(tabPanel);

      final Resizable resize = new Resizable(panel, Dir.E, Dir.SE, Dir.S);
      resize.setMinHeight(100);
      resize.setMinWidth(100);
      resize.setDynamic(true);
