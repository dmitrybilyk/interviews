...
@Detail(name = "Dashboard", icon = "dashboard", category = "Charts", classes = {
    Data.class, RadarData.class, CompanyDetailsEditor.class, FormattedNumericFilter.class,
    DashboardDataProperties.class, RadarDataProperties.class})
public class DashboardExample implements IsWidget, EntryPoint {
  ...
  public Widget asWidget() {
    if (panel == null) {
      ...
      FormattedNumericFilter priceFilter = new FormattedNumericFilter(dataProperties.price(), new DoublePropertyEditor(),
          "0.00");
      FormattedNumericFilter revenueFilter = new FormattedNumericFilter(dataProperties.revenue(), new DoublePropertyEditor(),
          "0.00");
      FormattedNumericFilter growthFilter = new FormattedNumericFilter(dataProperties.growth(), new DoublePropertyEditor(),
          "0.00");
      FormattedNumericFilter productFilter = new FormattedNumericFilter(dataProperties.product(), new DoublePropertyEditor(),
          "0.00");
      FormattedNumericFilter marketFilter = new FormattedNumericFilter(dataProperties.market(), new DoublePropertyEditor(),
          "0.00");
  ...
  private void initializeGrid() {
    ...
    columns.add(new ColumnConfig<Data, String>(dataProperties.name(), 120, "Name"));
