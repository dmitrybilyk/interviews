...
public class ListViewDndExample implements IsWidget, EntryPoint {
  ...
  public Widget asWidget() {
    if (vp == null) {
      ...
      new ListViewDragSource<StockProxy>(list1).setGroup("top");
      new ListViewDragSource<StockProxy>(list2).setGroup("top");

      new ListViewDropTarget<StockProxy>(list1).setGroup("top");
      new ListViewDropTarget<StockProxy>(list2).setGroup("top");
      ...
      new ListViewDragSource<StockProxy>(list1).setGroup("bottom");
      new ListViewDragSource<StockProxy>(list2).setGroup("bottom");
