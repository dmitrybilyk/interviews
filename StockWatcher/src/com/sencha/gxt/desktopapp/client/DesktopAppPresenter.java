 ...
 * invoke {@link #onLogin(com.sencha.gxt.desktopapp.client.LoginModel)} prior to invoking these methods will
...
public interface DesktopAppPresenter {
   ...
   * @return {@link com.sencha.gxt.desktopapp.client.DesktopAppPresenter.LoginStatus#SUCCESS} if the user is successfully logged in.
   *         See {@link com.sencha.gxt.desktopapp.client.DesktopAppPresenter.LoginStatus} for other possible
   *         outcomes.
   */
   ...
   * @return {@link com.sencha.gxt.desktopapp.client.DesktopAppPresenter.ProfileStatus#SUCCESS} if the profile update was successful.
   */
