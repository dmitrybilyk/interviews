...
public class SpreadsheetChartListStoreAdapter extends ListStore<Row> {
  ...
  public void addFilter(StoreFilter<Row> filter) {
    listStore.addFilter(filter);
  }

  public void addSortInfo(int index, StoreSortInfo<Row> info) {
    listStore.addSortInfo(index, info);
  }

  public void addSortInfo(StoreSortInfo<Row> info) {
  ...
  public LinkedHashSet<StoreFilter<Row>> getFilters() {
  ...
  public Record getRecord(Row data) {
    return listStore.getRecord(data);
  }

  public List<StoreSortInfo<Row>> getSortInfo() {
  ...
  public void removeFilter(StoreFilter<Row> filter) {
