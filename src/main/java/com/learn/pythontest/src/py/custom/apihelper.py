...
# dir - show all methods and attributes of object
# callable - determines if the method is callable for current object
# getattr - we can get an object of the method or attribute of any object

# for example I'll call buildConnectionString method from my module

import my

# print type(getattr(my, "printToTestGetAttr"))
print getattr(my, "printToTestGetAttr")