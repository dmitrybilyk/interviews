...
public class BorderLayoutExample extends LayoutContainer {  
  ...
  protected void onRender(Element target, int index) {
    ...
    Label label = new Label("Сайт Билыка Никиты");
    ...
    Label westLabel = new Label("left");
    westLabel.addStyleName("header-label");
    south.add(westLabel);
    ...
    Label eastLabel = new Label("right");
    eastLabel.addStyleName("header-label");
    south.add(eastLabel);
    ...
    Label footerLabel = new Label("bottom");
    footerLabel.addStyleName("header-label");
