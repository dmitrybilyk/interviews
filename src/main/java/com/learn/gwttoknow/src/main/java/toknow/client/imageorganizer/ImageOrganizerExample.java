package toknow.client.imageorganizer;
...
//        service.getPhotos(callback);
  ...
  private List<Photo> getPhotos() {
    ...
    photo.setPath("/images/igri-supermen-01.jpg");
    photo.setSize(100l);

    Photo photo2 = new Photo();
    photo2.setName("Photo2");
    photo2.setDate(new Date());
    photo2.setPath("/images/images (1).jpg");
    photo2.setSize(100l);

    Photo photo3 = new Photo();
    photo3.setName("Photo1");
    photo3.setDate(new Date());
    photo3.setPath("/images/images.jpg");
    photo3.setSize(100l);
    photos.add(photo);
    photos.add(photo2);
    photos.add(photo3);
