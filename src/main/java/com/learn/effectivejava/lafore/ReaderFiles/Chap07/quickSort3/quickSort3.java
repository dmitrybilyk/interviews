package com.learn.effectivejava.lafore.ReaderFiles.Chap07.quickSort3;
...
//--------------------------------------------------------------
   public ArrayInsQuickSort(int max)          // constructor
      {
...
//--------------------------------------------------------------
   }  // end class ArrayInsMedianOfThree
////////////////////////////////////////////////////////////////
class QuickSort3App
   {
   public static void main(String[] args)
      ...
      ArrayInsMedianOfThree arr;                 // reference to array
      arr = new ArrayInsMedianOfThree(maxSize);  // create the array
...
////////////////////////////////////////////////////////////////
class ArrayInsMedianOfThree
{
  private long[] theArray;          // ref to array theArray
  private int nElems;               // number of data items
  //--------------------------------------------------------------
  public ArrayInsMedianOfThree(int max)          // constructor
  {
    theArray = new long[max];      // create the array
    nElems = 0;                    // no items yet
  }
