package com.learn.hibernate.mappings.onetomany.oneToManyBidirectional.util;
...
public class HibernateAnnotationUtil {
	...
	static {
		try {
            ...
            configuration.configure("mappings.onetomany.bidirectional/one-to-one-bidirectional-hibernate.cfg.xml");
