package com.learn.hibernate.mappings.manytomany.manyToManyUnidirectional.util;
...
public class HibernateAnnotationUtil {
	...
	static {
		try {
            ...
            configuration.configure("mappings.manytomany.unidirectional/many-to-many-unidirectional-hibernate.cfg.xml");
