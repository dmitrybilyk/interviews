package com.learn.interview_questions.Threads.waitandnotify.programcreek.morecomplex;
...
class Producer extends Thread {
    ...
    public synchronized String getMessage() throws InterruptedException {
        ...
        while (messages.size() == 0) {
            wait();//By executing wait() from a synchronized block, a thread gives up
