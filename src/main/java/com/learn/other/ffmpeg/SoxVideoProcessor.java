 ...
 * Radek Mensik, 6.2.13
 */
public class SoxVideoProcessor implements AudioProcessor {

  private static Logger logger = LoggerFactory.getLogger(SoxVideoProcessor.class);
  ...
  public SoxVideoProcessor() {
  }

  public SoxVideoProcessor(String path_to_sox) {
   ...
   * @throws com.learn.other.ffmpeg.RequestFailedException
   */
